...
export const useCarrinhoContext = () => {
    ...
    function adicionarProduto(novoProduto){
        ...
        //Não precisa do else pois tem o return:
    ...
    useEffect(() => {
      const { novoTotal, novaQuatidade } = carrinho.reduce((contador, produto) => 
      ({novaQuatidade: contador.novaQuatidade + produto.quantidade, novoTotal: contador.novoTotal + (produto.valor * produto.quantidade)}), {novaQuatidade: 0, novoTotal: 0});
      setQuantidadeProdutos(novaQuatidade);
